...
const translations = {
  ...
  ur: {
    ...
    // Product (same as before, add Urdu translations as you have them)
    ...
    'products.title': 'کیڑے مار ادویات اور کھادیں',
    'products.description': 'زرعی مصنوعات اور ان کی تفصیلات کا نظم کریں',
    'products.add_new': '+ نئی مصنوعہ شامل کریں',
    'products.table.name': 'نام',
    'products.table.type': 'قسم',
    'products.table.active_ingredient': 'فعال جزو',
    ...
    'product_form.title_edit': 'مصنوعہ میں ترمیم کریں',
    'product_form.read_form': 'فارم پڑھیں',
    'product_form.product_name': 'مصنوعہ کا نام *',
    'product_form.type': 'قسم *',
    'product_form.subtype': 'ذیلی قسم',
    'product_form.active_ingredient': 'فعال جزو',
    'product_form.mode_of_action': 'عمل کا طریقہ',
    ...
    'product_form.dosage': 'خوراک',
    'product_form.safety_info': 'حفاظتی معلومات',
    'product_form.manufacturer': 'صنعت کار',
    'product_form.submit_create': 'مصنوعہ بنائیں',
    'product_form.submit_update': 'مصنوعہ اپ ڈیٹ کریں',
